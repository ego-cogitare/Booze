<div id="vremya-vypit" class="section sectionTwo swiper-slide">

    <div class="container container-1">
        <div class="text-wrap bounceIn timeToDrink wow-mobile" data-wow-delay="0.3s" data-wow-duration="0.5s">
            <div class="ttl decoration">Уже с нами</div>
            <div class="sub_ttl">
                Узнай какие рестораны с нами
            </div>
        </div>
    </div>

    <div class="cocktailWrap">
